...
var setTemplate='<div class="t-table-wrap"><table class="t-table-condensed">'+'<thead>'+'<tr>'+'<th class="t-arrow">'+settings.arrowPrev+'</th>'+'<th colspan="5" class="t-month"></th>'+'<th class="t-arrow">'+settings.arrowNext+'</th>'+'</tr>'+'<tr>'+
...
var Arrow_2=pr_el.find('.t-arrow');if(Date.UTC(y,m+numCalendar)!=limitNextMonth&&Date.UTC(y,m)===limitPrevMonth){Arrow_2[Arrow_2.length-1].className='t-arrow'
Arrow_2[0].className='t-arrow t-disabled'}else{Arrow_2[0].className='t-arrow'}
if(Date.UTC(y,m+numCalendar)===limitNextMonth||new Date(Date.UTC(y,m+numCalendar)).getMonth()===new Date(dataUTC[0]).getMonth()+1){Arrow_2[Arrow_2.length-1].className='t-arrow t-disabled'}
if(Date.UTC(y,m+numCalendar)<limitNextMonth){Arrow_2[Arrow_2.length-1].className='t-arrow'}
