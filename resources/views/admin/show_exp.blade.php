										...
										*/ 
                                        ...
                                        <tr>
                                            ...
                                            <td >
												...
												<p><a href="{{ url('admin/exp_details/'.$superstars->id)}}" class="btn btn-primary btn-xs" role="button">Details</a></p>
												<p><a href="{{ url('admin/update_smlistings_toprated/'.$superstars->id)}}" class="btn btn-primary btn-xs" role="button">Similar Listings</a></p>
