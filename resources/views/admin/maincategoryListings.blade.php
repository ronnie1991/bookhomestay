                ...
                <div class="col-md-12">                            
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Main Category Listings</h3>
                                ...
                                <table id="customers2" class="table datatable">
                                    ...
                                    @foreach ($promotions as $promotion)
                                        ...
                                        <tr>
											...
											<!--<img src="{{ asset('site_images/main_category')}}/{{ $promotion->promo_image }}" alt="" height="60" width="120">-->
											<img src="{{asset('site_images/main_category')}}/{{ $promotion->promo_image }}" alt="" height="60" width="120">
											</td>
                                            <td >{{ $promotion->cname }}</td>
                                           
                                            <?php /* ?> <td >
                                                <a href="{{ url('admin/DestroyPromo/'.$promotion->id)}}" class="btn btn-danger" role="button">Edit</a>
												
                                               @if($promotion->activated == 1)
