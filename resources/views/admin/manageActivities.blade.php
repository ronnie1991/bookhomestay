						 ...
						 <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">                                    
                                    <h3>Add Activity</h3>                                
                                    <form class="form-horizontal" action="{{ url('admin/addactivity') }}" method="post">
                                        @csrf
                                    <div class="panel-body">
                ...
                <div class="col-md-12">                            
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Activity Listings</h3>
                            <div class="btn-group pull-right">
                                ...
                                <table id="activitiesTable" class="table datatable">
                                    ...
                                    @foreach ($activities as $activity)
                                        ...
                                        <tr>
                                            ...
                                            <td >{{ $activity->name }}</td>
                                            <td >
                                                <a href="{{ url('admin/editactivity/'.$activity->id.'') }}" class="btn btn-danger" role="button">Edit</a>
                                            </td>                   
                                        </tr>  
                                    @endforeach                                         
                                    </tbody>
