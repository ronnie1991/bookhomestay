...
@section('content')
	    ...
	    <div class="page-title">                    
	        <h2><span class="fa fa-cogs"></span>Add Big Days</h2>
	    </div>
	    <!-- END PAGE TITLE -->                     
						 ...
						 <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">                                    
                                    <h3>Add Big Days</h3>                                
                                    <form class="form-horizontal" action="{{ url('admin/add_bigday_details') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                    <div class="panel-body">   
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-9">
												<select class="form-control select" name="place">
													...
													@foreach($placeforselect as $places)
