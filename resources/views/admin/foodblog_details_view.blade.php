...
@section('content')
	    ...
	    <div class="page-title">                    
	        <h2><span class="fa fa-cogs"></span>Food Blog Details</h2>
	    </div>
	    <!-- END PAGE TITLE -->                     
	    ...
	    <div class="page-content-wrap">
	        ...
	        <div class="row">                        									
			<div class="col-md-12">						
			<!---	 [id] => 1 [place] => 1 [rank] => 1 [similar_listings] => 1 [name] => Malnad cuisine [title] => Shiv Ratri [image] => BH0001stay10.jpg [description] 	----->                            <!-- START VALIDATIONENGINE PLUGIN -->        
			<div class="panel panel-default">                 
			<div class="panel-body">                     
			<h3>Update Food Blog</h3>                    
			<!---<form class="form-horizontal" action="{{ url('admin/update_superstar_details') }}" method="post" enctype="multipart/form-data">--->	
			<form class="form-horizontal" action="{{ url('admin/update_foodblog') }}" method="post" enctype="multipart/form-data">								
			@csrf                                  
			<div class="panel-body">   								
			@foreach($food_blog as $sstar)					
			@php						
...
<div class="form-group">                
			...
			<div class="col-md-9">                               
			<input type="text" class="form-control" name="name" value="{{ $sstar->name }}" placeholder="" required id="postcode"/>  
			</div>                                
			</div>			
			...
			<img src="{{asset('food_blog_pic')}}/{{ $sstar->image }}" alt="" height="60" width="120">			
			</p>												                         
			</div>                              
			</div>								
			<div class="form-group">			
