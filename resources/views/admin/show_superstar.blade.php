                                ...
                                <table id="customers2" class="table datatable">
									...
									<?php
										...
										*/ 
                                        ...
                                        <tr>
                                            <td>{{ $i }}</td>
                                            <td >{{ $superstars->name }}</td>
                                            <td >{{ $superstars->title }}</td>
											<td >
											<img src="{{ asset('superstar_pic')}}/{{ $superstars->image }}" alt="" height="60" width="120">
											</td>
											
                                           
                                            <td >
                                                <!--<a href="" class="btn btn-primary btn-xs" role="button">Edit</a>-->
												<p><a href="{{ url('admin/superstar_details/'.$superstars->id)}}" class="btn btn-primary btn-xs" role="button">Details</a></p>
												
												<p><a href="{{ url('admin/update_smlistings_superstar/'.$superstars->id)}}" class="btn btn-primary btn-xs" role="button">Similar Listings</a></p>
