...
@section('content')
	    ...
	    <div class="page-title">                    
	        <h2><span class="fa fa-cogs"></span>Update Similar Listings data For Top Rated.</h2>
	    </div>
	    <!-- END PAGE TITLE -->                     
	    ...
	    <div class="page-content-wrap">
						 ...
						 <!-- START HORIZONTAL FORM SAMPLE -->
                            <div class="panel panel-default">
                                <div class="panel-body">
                                   ...
                                   <h3>Details of Top Rated Experience Id: {{ $exps->id }}</h3>
										
										
										
										<div class="form-group">
                                            <label class="col-sm-4 control-label">Top Rated Experience name</label>
                                            <div class="col-md-8">
                                                <p class="form-control-static">
												<input type="text" class="form-control" name="hname" value="{{ $exps->name }}" required id="postcode"/> 
												</p>												
                                            </div>
                                        </div>
										...
										<div class="form-group">
                                            <label class="col-sm-4 control-label">Top Rated Experience Image</label>
                                            <div class="col-md-8">
                                                <p class="form-control-static">
												<img src="{{asset('superstar_pic')}}/{{ $exps->image }}" alt="" height="60" width="120">
												</p>
			...
			<div class="row"> 
				...
				$focus=explode(",",$exps->similar_listings);
				$i++;
				@endphp
			
				
									    <form class="form-horizontal" action="{{ url('admin/update_pro_to_exp') }}" method="post" enctype="multipart/form-data">
                                        @csrf     
												<input type="hidden" name="expid" value="{{ $exps->id }}"/>										
                                        <tr>
                                            <td>{{ $i }}</td>
                                            <td>
												<label class="check">
