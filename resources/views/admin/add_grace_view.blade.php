...
@section('content')
	    ...
	    <div class="page-title">                    
	        <h2><span class="fa fa-cogs"></span>Add Grace & Beauty</h2>
	    </div>
	    <!-- END PAGE TITLE -->                     
						 ...
						 <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">                                    
                                    <h3>Add Grace & Beauty</h3>                                
                                    <form class="form-horizontal" action="{{ url('admin/add_grace_details') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                    <div class="panel-body">   
