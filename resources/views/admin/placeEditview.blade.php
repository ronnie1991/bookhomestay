						 ...
						 <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                    
                                    ...
                                    <form class="form-horizontal" action="{{ url('admin/updateplace') }}" method="post" enctype="multipart/form-data">

                                        @csrf
										<input type="hidden" class="form-control" value="{{$data->id}}" name="placeid" required id="postcode"/> 
                                    ...
                                    <div class="panel-body">   
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input type="text" class="form-control" value="{{$data->place}}" name="placename" required id="postcode"/>                                        
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-8">
												...
												<img src="{{asset('placebanner')}}/{{ $data->banner }}" alt="" height="60" width="120">
												</p>
