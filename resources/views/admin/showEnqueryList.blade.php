...
@section('content')
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#">Customer Enquery</a></li>                    
                ...
                <div class="col-md-12">                            
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Enquery List</h3>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="customers2" class="table datatable">
									...
									@foreach ($enquerylist as $slCount=> $enqDtils)
                                        ...
                                        <tr>
											...
											<td >{{ $enqDtils->lastname }}</td>

											<td >{{ $enqDtils->email }}</td>
											
											<td >{{ $enqDtils->phone }}</td>
