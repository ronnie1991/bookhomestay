...
@section('content')
        ...
        <div class="page-content-wrap">
			...
			<form class="form-horizontal" action="{{ url('admin/addholiday') }}" method="post" enctype="multipart/form-data">     
			@csrf                             
			<div class="panel-body">   		
			<div class="form-group">          
			<label class="col-md-3 control-label">Holiday Category Name:</label>        
			<div class="col-md-9">                                      
			<input type="text" class="form-control" name="cname" required id="postcode"/>              
			</div>                          
			</div>								
			<div class="form-group">			
			<label class="col-md-3 control-label">Image:</label>  
			<div class="col-md-3">								
			<input type="file" class="fileinput btn-primary" name="image" required title="Browse file"/>		
			</div>								
			</div>							
			<div class="btn-group pull-right">  
			<button class="btn btn-primary" type="button" onClick="jvalidate.resetForm();$('#gender').next('.bootstrap-select').removeClass('error').removeClass('valid')">Hide prompts</button>                                            <button class="btn btn-primary" name="submit" type="submit">Submit</button> 
                ...
                <div class="col-md-12">                            
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Holiday Category Listings</h3>
                            <div class="btn-group pull-right">
                                ...
                                <table id="customers2" class="table datatable">
                                    ...
                                    @foreach ($holiday as $holidays)
                                        ...
                                        <tr>
                                            <td>{{ $i }}</td>
                                            <td >
											<!--<img src="{{ asset('site_images/holiday_category')}}/{{ $holidays->image }}" alt="" height="60" width="120">-->
											<img src="{{asset('site_images/holiday_category')}}/{{ $holidays->image }}" alt="" height="60" width="120">
											</td>
                                            <td >{{ $holidays->holiday_category }}</td>
                                           
                                            <td >
                                                 <a href="{{ url('admin/holidayEditview/'.$holidays->id)}}" class="btn btn-danger btn-xs" role="button">Edit</a>
