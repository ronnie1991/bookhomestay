                ...
                <div class="col-md-12">                            
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Request Booking Listings</h3>
									...
									<?php
										...
										*/ 
                                        ...
                                        <tr>
											...
											<td >@php
											if($bookings['availble']==1)
											{ @endphp
												
												<a href="{{ url('admin/change_property_status/'.$bookings['property_id'],'booking')}}" title="Make Available" class="btn btn-primary btn-xs" role="button">NA</a>
											@php 
											}
											else{
											@endphp
											<a href="{{ url('admin/change_property_status/'.$bookings['property_id'],'booking')}}" title="Make NotAvailable" class="btn btn-success btn-xs" role="button">Available</a>
											@php 
											}
											@endphp
											<br>
											<p><a href="{{ url('admin/booking_details/'.$bookings['property_id'],$bookings['bookingid'])}}" class="btn btn-primary btn-xs" role="button">Details</a></p>
											<br>
