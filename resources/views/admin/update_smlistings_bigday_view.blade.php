...
@section('content')
	    ...
	    <div class="page-title">                    
	        <h2><span class="fa fa-cogs"></span>Update Similar Listings data For Big Day.</h2>
	    </div>
	    <!-- END PAGE TITLE -->                     
	    ...
	    <div class="page-content-wrap">
						 ...
						 <!-- START HORIZONTAL FORM SAMPLE -->
                            <div class="panel panel-default">
                                <div class="panel-body">
                                   ...
                                   <h3>Details of Bg Days Id: {{ $bigdays->id }}</h3>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-8">
												...
												<input type="text" class="form-control" name="hname" value="{{ $bigdays->title }}" required id="postcode"/> 
												</p>												
                                            </div>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <p class="form-control-static">
												<img src="{{asset('placebanner')}}/{{ $bigdays->image }}" alt="" height="60" width="120">
												</p>
			...
			<div class="row"> 
				...
				@php
				$focus=explode(",",$bigdays->similar_listings);
				$i++;
				@endphp
			
				
									    <form class="form-horizontal" action="{{ url('admin/update_pro_to_big') }}" method="post" enctype="multipart/form-data">
                                        @csrf     
												<input type="hidden" name="bigdayid" value="{{ $bigdays->id }}"/>										
                                        <tr>
                                            <td>{{ $i }}</td>
                                            <td>
												<label class="check">
