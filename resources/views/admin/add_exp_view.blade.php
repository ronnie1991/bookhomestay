...
@section('content')
	    ...
	    <div class="page-title">                    
	        <h2><span class="fa fa-cogs"></span>Add Experience</h2>
	    </div>
	    <!-- END PAGE TITLE -->                     
						 ...
						 <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">                                    
                                    <h3>Add Top rated Experience</h3>                                
                                    <form class="form-horizontal" action="{{ url('admin/add_exp_details') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                    <div class="panel-body">  
									...
									<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-9">
												<select class="form-control select" name="propertyid">
													<option value="">Please Select</option>
													@foreach($property as $propertys)
														<option value="{{ $propertys->id }}">{{ $propertys->manual_pro_id }}</option>
													@endforeach			
												</select>
                                            </div>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="superstar_name" value="" required id="postcode"/>                                        
