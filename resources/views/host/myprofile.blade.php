				...
				@endphp	
                    ...
                    <div class="row">                        
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            ...
                            <div class="panel panel-default">                                
                                ...
                                <div class="panel-body form-group-separated">
									...
									<div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label">Rating</label>
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="{{$getcustomer->rating}} Star" class="form-control" disabled/>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            ...
                            <form class="form-horizontal" action="{{ url('host/updatehostprofile') }}" method="post" enctype="multipart/form-data">
							@csrf
                            <div class="panel panel-default">
                                <div class="panel-body">
                                ...
                                <div class="panel-body form-group-separated">
									...
									<div class="form-group">
                                            <label class="col-sm-3 control-label">My Image</label>
                                            <div class="col-md-9">
                                                <p class="form-control-static">
												
												<img src="{{asset('host_pic')}}/{{ $getcustomer->image }}" alt="" height="60" width="120">
												</p>
									...
									<input type="hidden" value="{{$hostid}}" name="userid" class="form-control"/>
                                    <div class="form-group">
