										...
										*/ 
                                        ...
                                        <tr>
											...
											{ @endphp
												...
												<a href="{{ url('host/change_property_status/'.$bookings['property_id'],'booking')}}" title="Make Available" class="btn btn-primary btn-xs" role="button">NA</a>
											@php 
											}
											else{
											@endphp
											<a href="{{ url('host/change_property_status/'.$bookings['property_id'],'booking')}}" title="Make NotAvailable" class="btn btn-success btn-xs" role="button">Available</a>
											@php 
											}
											@endphp
											<br>
