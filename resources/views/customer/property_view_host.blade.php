									...
									<?php
										...
										*/ 
                                        ...
                                        <tr>
                                            ...
                                            <td >{{ $properties->manual_pro_id }}</td>
											...
											{ @endphp
												...
												<a href="{{ url('host/change_property_status/'.$properties->id,'property')}}" title="Make Available" class="btn btn-primary btn-xs" role="button">NA</a>
											@php 
											}
											else{
											@endphp
											<a href="{{ url('host/change_property_status/'.$properties->id,'property')}}" title="Make NotAvailable" class="btn btn-success btn-xs" role="button">Available</a>
                                            ...
                                            <td >
												...
												<p><a href="{{ url('admin/add_room_pics/'.$properties->id)}}" class="btn btn-primary btn-xs" role="button">Add Rooms Pics</a></p><?php */ ?>
												<p><a href="{{ url('host/property_details/'.$properties->id)}}" class="btn btn-primary btn-xs" role="button">Details</a></p>
