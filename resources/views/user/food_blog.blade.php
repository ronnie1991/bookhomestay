        ...
        <main>
            ...
            <div id="unique" class="explor-sec margin_80_0" style="margin-top:50px;">
                <div class="container clearfix">
                  ...
                  @foreach ($food_blog as $kc=>$mustnot)
                    ...
                    @endphp
                        ...
                        <div class="swiper-slide">
                            <div class="explor-media">
                                ...
                                <div class="media">
                                    <img class="d-flex align-self-center mr-3" src="{{ asset('placebanner')}}/{{ $ee->banner }}" alt="No image">
            ...
            <div class="location-sec recommended-sec" style="padding-top:0px !important;">
                    <div class="container">
                         @foreach ($food_blog as $cl=>$mustnot)
                        @php
                        $ee = DB::table('place')->where(['id'=>$mustnot->place])->first(); 
                        @endphp
                            <div  id="{{$cl}}"></div>
                            <h1>Budget tours in {{ $ee->place }}</h1>
                            <div class="row">
                                @php
                        
                                $getproperty = DB::table('food_blog')->where('place',$mustnot->place)->get();
                                @endphp
                                <div class="col-12">
                                              ...
                                              @foreach ($getproperty as $showpro)
                                                <div class="swiper-slide">
                                                    <div class="team-block">
                                                        <div class="box_grid">
                                                        <figure>
                                                         <a href="{{ url('/foodblog_details_front/'.$showpro->id)}}" target="_blank">                                    
                                                            <img src="{{ asset('food_blog_pic')}}/{{ $showpro->image }}" alt="" />
                                                            </a>
                                ...
                                <div class="col-sm-12">
                                 <a class="show-all" href="{{ url('/food_all/'.$mustnot->place)}}">Show all (200+)  <i class="la la-angle-right"></i></a>
                               </div>
                            </div>
                            <br>
                            <hr>
