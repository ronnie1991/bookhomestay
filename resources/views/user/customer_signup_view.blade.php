        ...
        <div class="container" style="margin-top: 156px;margin-bottom: 69px;">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control inp" name="name" type="text" autocomplete="off"  value="{{ old('name') }}" required="required">                    
                </div>                
                
                <div class="form-group">
                    <label>Your Email*</label>
                    <input class="form-control inp" type="email" name="email" autocomplete="off"  value="{{ old('email') }}" required="required">
                </div>
                <div class="form-group">
