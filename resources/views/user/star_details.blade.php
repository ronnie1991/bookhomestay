                ...
                <div class="row justify-content-between">
                    <div class="col-lg-12 wow" data-wow-offset="150" style="visibility: unset;">
                        <figure class="block-reveal">
                            ...
                            <img src="{{ asset('superstar_pic')}}/{{ $exps->image }}" class="img-fluid" width="300px" height="165" style="float: left; margin: 4px 16px 2px 0px; border: 1px solid #000000e6;" alt="">
                            <span style="font-size: 15px;text-align: justify;" >{!! $exps->description !!}</span>
                        </figure>
                    </div>
