...
<body>
    <div id="page" class="theia-exception">
        ...
        <main>
			...
			<?php $__currentLoopData = $bigday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bigdays): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="container margin_55" >
                <div class="main_title_2" style="margin-bottom: 15px;">
                    <h2> <?php echo e(date('d M Y',strtotime($bigdays->date))); ?></h2>
                    <p><?php echo e($bigdays->title); ?></p>
                </div>
                <div class="row justify-content-between">
                    <div class="col-lg-12 wow" data-wow-offset="150" style="visibility: unset;">
                        <figure class="block-reveal">
                            <div class="block-horizzontal"></div>
                            <img src="<?php echo e(asset('superstar_pic')); ?>/<?php echo e($bigdays->image); ?>" class="img-fluid" alt="" width="300px" height="165" style="float: left; margin: 4px 16px 2px 0px; border: 1px solid #0e0d0de6;" >
                            <span style="font-size: 15px;text-align: justify;" ><?php echo $bigdays->description; ?></span>
                        </figure>
                    </div>
                </div>
                <!--/row-->
        ...
        <!-- /container -->  
		 ...
		 <div class="location-sec similar-listing recommended-sec">
                <div class="container">
                    <h1>Enjoy <?php echo e($bigdays->title); ?> season at :</h1>
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="swiper-slide swiper-slide-active" style="width: 255px; margin-right: 30px;">
                                    <div class="team-block">
                                        ...
                                        <div class="team-info text-left">
                                            ...
                                            <p>From <strong style="font-family: sans-serif;">&#8377;</strong><?php echo e($sls->price); ?> per person</p>
                                            <div class="rating">
                                                <?php if($sls->rating=='1') { ?>
