...
<body>
    <div id="page" class="theia-exception">
        ...
        <main>
            ...
            <?php $__currentLoopData = $grace; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kc=>$mustnot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="location-sec recommended-sec" style="padding-top:0px !important;">
                    <div class="container">
                        <?php $__currentLoopData = $grace; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cl=>$mustnot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        $ee = DB::table('place')->where(['id'=>$mustnot->placeid])->first(); 
                        ...
                        <?php if(count($getproperty) > 0): ?>
                            ...
                            <h1>Places to see in <?php echo e($ee->place); ?></h1>
                            <div class="row">
                                <div class="col-12">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="team-block">
                                                        <div class="box_grid">
                                                        <figure>
                                                            <a href="<?php echo e(url('/grace_details_front/'.$sightSenDils->id)); ?>" target="_blank">
                                                                <img src="<?php echo e(asset('placebanner')); ?>/<?php echo e($sightSenDils->image); ?>" alt="" />
                                                                </a>
                                                            <small><?php echo e($sightSenDils->title); ?></small>
                                                        </figure>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-sm-12">
                                    <a class="show-all" href="<?php echo e(url('/grace_all/'.$mustnot->placeid)); ?>">Show all   <i class="la la-angle-right"></i></a>
                                </div>  
                            </div>
                            <br>
                            <hr>
