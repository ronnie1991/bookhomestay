...
<?php $__env->startSection('content'); ?>
	    ...
	    <div class="page-title">                    
	        <h2><span class="fa fa-cogs"></span>Manage Activities</h2>
	    </div>
	    <!-- END PAGE TITLE -->                     
						 ...
						 <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">                                    
                                    <h3>Add Activity</h3>                                
                                    <form class="form-horizontal" action="<?php echo e(url('admin/addactivity')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                    <div class="panel-body">
                ...
                <div class="col-md-12">                            
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Activities Listings</h3>
                            <div class="btn-group pull-right">
                                ...
                                <table id="activitiesTable" class="table datatable">
                                    ...
                                    <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <a href="<?php echo e(url('admin/editactivity/'.$activity->id.'')); ?>" class="btn btn-danger" role="button">Edit</a>
                                            </td>                   
                                        </tr>  
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                         
                                    </tbody>
