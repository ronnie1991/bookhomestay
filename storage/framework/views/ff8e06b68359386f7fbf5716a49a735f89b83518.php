        ...
        <main> 
            ...
            <div id="unique" class="explor-sec margin_80_0" style="margin-top:50px;">
                    ...
                    <h1>Newly added top rated experiences</h1>
                        <div class="row">
                             <?php $__currentLoopData = $topRatedExprience; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alltopRatedExprience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-sm-6 col-md-3">
                                    <div class="holidayspot-list">
                                        <div class="team-block">
                                            <div class="img-sec">
                                                <a href="<?php echo e(url('/exp_details_front/'.$alltopRatedExprience->id)); ?>">
                                                    <img src="<?php echo e(asset('superstar_pic')); ?>/<?php echo e($alltopRatedExprience->image); ?>" alt="" />
                                                </a>
                                                <small><?php echo e($alltopRatedExprience->name); ?></small>
                                            </div>
                                            <div class="team-info text-left">
                                                <h3><?php echo e($alltopRatedExprience->title); ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
