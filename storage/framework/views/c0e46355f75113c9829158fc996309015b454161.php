...
<body>
    <div id="page" class="theia-exception">
        ...
        <main>
			...
			<?php $__currentLoopData = $superstar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="container margin_55" >
                <div class="main_title_2" style="margin-bottom: 15px;">
                    <h2><?php echo e($exps->name); ?></h2>
                    <p><?php echo e($exps->title); ?></p>
                </div>
                <div class="row justify-content-between">
                    <div class="col-lg-12 wow" data-wow-offset="150" style="visibility: unset;">
                        <figure class="block-reveal">
                            <div class="block-horizzontal"></div>
                            <img src="<?php echo e(asset('superstar_pic')); ?>/<?php echo e($exps->image); ?>" class="img-fluid" width="300px" height="165" style="float: left; margin: 4px 16px 2px 0px; border: 1px solid #000000e6;" alt="">
                            <span style="font-size: 15px;text-align: justify;" ><?php echo $exps->description; ?></span>
                        </figure>
                    </div>
                            ...
                            <div class="similar-slider">
                                <div class="swiper-container swiper-container-horizontal">
                                    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                        ...
                                        <?php
                                $dd = DB::table('superstar')->where('id',$superstarId)->first();
