    ...
    <div id="page" class="theia-exception">
		...
		<?php */ ?>
			...
			<div class="location-sec recommended-sec" style="margin-top:50px !important;">
                    <div class="container">
                        <h1 style="text-align: center;"> Places to see in <?php echo e($place->place); ?></h1>
                        <div class="row">
                            
							<?php $__currentLoopData = $grace_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exfbd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						
                                <div class="col-sm-6 col-md-3">
                                    <div class="holidayspot-list">
                                        <div class="team-block">
                                            <div class="img-sec">
                                                <a href="<?php echo e(url('/grace_details_front/'.$exfbd->id)); ?>">
                                                    
                                                    <img src="<?php echo e(asset('placebanner')); ?>/<?php echo e($exfbd->image); ?>" alt="" />
                                                </a>
                                            </div>
                                            <div class="team-info text-left">
                                                <h3><?php echo e($exfbd->title); ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
