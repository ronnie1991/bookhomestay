                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-4">
                              <div class="searchmap-fixed search-dtl-right sticky_horizontal" id="reservationBox">
                                <form class="form-horizontal" method="post" action="<?php echo e(url('/setSessionDataForPurchase')); ?>" name="purchase" id="purchase" >
                                  ...
                                  <input type="hidden" id="propertyPrice" name="price" value="<?php echo e($prop->price); ?>">
                                  ...
                                  <div class="theiaStickySidebar">
                                    <div class="box_detail">
                                      <div class="price" id="price">
                                          ...
                                          <span style="text-decoration:line-through;color: rgba(118, 108, 108, 0.89); font-family: sans-serif;">Rs. <?php echo e($prop->original_price); ?> </span><span style=" font-family: sans-serif;">Rs. <?php echo e($prop->price); ?> </span>
